                  ...
                  Container(
                    ...
                    child: ClipRRect(
                      ...
                      child: Container(
                          width: 46.h,
                          height: 46.h,
                          child: Image.asset(Tools().getIcon("info.png"))),
                    ),
                  ),
                ],
              ),
          ...
          bottom: TabBar(
            ...
            tabs: [
              Text(
                "Mentally",
                style:
                    _tabController.index == 0 ? kText20Bold_1 : kText20Bold_4,
              ),
              Text(
                "Physically",
                style:
                    _tabController.index == 1 ? kText20Bold_1 : kText20Bold_4,
              ),
              Text(
                "Nutrition",
                style:
                    _tabController.index == 2 ? kText20Bold_1 : kText20Bold_4,
              )
            ],
          ),
        ),
